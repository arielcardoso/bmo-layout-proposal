        ...
        <div class="tab-pane fade show active" id="payment-tab" role="tabpanel" aria-labelledby="payment-tab-bt">
          <div className="card card-in-tab">
            ...
            <div className="card-footer">
              ...
              <div>
                <a href="#" className="btn btn-sm btn-default">Add a Payee</a>
                <a href="#" className="btn btn-sm btn-default">Add another Payment Method</a>
              </div>
            </div>
          </div>
        </div>
