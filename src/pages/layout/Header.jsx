    ...
    <div className='ui-header'>
      ...
      <div className="menu">
        ...
        <div className='notifications dropdown'>
          <a href="{() => false}" className='' role="button" id='dropdownNotifications' data-bs-toggle="dropdown" aria-expanded="false" >
            ...
            <li>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  <a href='{() => false}' class="row no-gutters align-items-center">
                    <div class="col-2">
        ...
        <div className='settings dropdown'>
          <a href="{() => false}" className='' role="button" id='dropdownSettings' data-bs-toggle="dropdown" aria-expanded="false" >
            <i className='bi bi-gear' ></i>
          </a>
          <ul class="dropdown-menu" aria-labelledby="dropdownSettings">
            <li><a class="dropdown-item" href="{() => false}">My Profile</a></li>
            <li><a class="dropdown-item" href="{() => false}">Security Settings</a></li>
